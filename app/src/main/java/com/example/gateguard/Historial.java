...
public class Historial extends AppCompatActivity {
    ...
    public void cerrarSesion() {
        ...
        Intent intent = new Intent(Historial.this, InicioSesion.class);
    ...
    public void regresarInicio() {
        ...
        Intent intent = new Intent(Historial.this, Ciudadelas.class);
        startActivity(intent);
    }

    public void soporte() {
        // Redirigir a la actividad Soporte
        Intent intent = new Intent(Historial.this, Soporte.class);
        startActivity(intent);
    }

    public void perfil() {
        // Redirigir a la actividad Perfil Usuario
        Intent intent = new Intent(Historial.this, PerfilUsuario.class);
        startActivity(intent);
    }
